...
### Key Contributions:
1. Synthetic datasets were generated using single-agent and multi-agent conversations.
...
1. **Single-Agent Dataset**: A single LLM was used to simulate both the scammer’s and the victim’s conversations. This dataset includes 1,600 conversations split evenly between scam and non-scam categories.
